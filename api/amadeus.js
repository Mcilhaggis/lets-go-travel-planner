...
function getActivity(city) { 
    return fetch('https://developers.zomato.com/api/v2.1/locations?query=' + city, {
     headers: {
...
return fetch('https://test.api.amadeus.com/v1/shopping/activities?latitude='+ geocode[0] +'&longitude='+geocode[1]+'&radius=1', {
    headers: {
